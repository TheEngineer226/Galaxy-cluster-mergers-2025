...
tf_density.add_layers(4, w=0.01, colormap="Greys")  # This creates alpha values
print("Density_tf Created...")

# Multivariate transfer function - FIXED VERSION
...
file_location = "shawn/multivariate_render.png"
